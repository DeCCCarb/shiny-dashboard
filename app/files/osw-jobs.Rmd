...
## For the total duration of all projects needed to meet your capacity goal of `r final_cap` (GW) for Floating Offshore Wind by `r final_year`, there would be `r scales::comma(const_njobs_label)` construction and `r scales::comma(om_njobs_label)` operations & maintenance jobs. 
