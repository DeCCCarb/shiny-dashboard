...
% ======================================================== SPLASH TEXT =======================================================
\begin{center}
\Huge\noindent\textbf{Rooftop Solar Job Impacts}  
...
glue::glue('For your Rooftop Solar project starting in {input$year_range_input_roof[1]}, there will be')
@
\\

<<output$roof_county_map_output, fig = TRUE , echo = FALSE, warning=FALSE, quiet = TRUE, message=FALSE, out.width = "50%">>=
library(usdata)
library(tmap)
library(tigris)
...
tm_shape(california_counties) +
 ...
 tm_layout(frame = FALSE,
    ...
    tm_credits(text = glue::glue('Total Jobs in {input$roof_counties_input}: '),
...
<<output$roof_jobs_output, fig = TRUE , echo = FALSE, warning=FALSE, out.width="100%">>=
