...
body <- dashboardBody(
    ...
    tabItems(
        ...
        tabItem(
            ...
            # left hand column ----
            column(width = 6, # background info box ----
                   box(
                       width = NULL,
   ...
   ########## Tool/Dashboard tabItem for floating offshore wind ###########
                          tabItem(tabName = 'f_osw', # Create a fluidRow ---
                                  fluidRow(
                                      # input box ----
                                      box(
                                          width = 4,
                          ...
                          tabItem(tabName = 'utility', # Create a fluidRow ---
                                  # fluidRow(
                                  #
                                  #     # input box ----
                                  #     box(width = 4,
                                  ...
                                  tabItem(tabName = 'lb_wind', # Create a fluid row
                                          # Create a fluidRow ---
                                          fluidRow(
                                              # input box ----
                                              box(
                                          ...
                                          tabItem(tabName = 'well_cap', fluidRow(
                                              box(
                                                  width = 4,
                                          ...
                                          tabItem(tabName = 'phaseout', # Create a fluidRow ---
                                                  fluidRow(
                                                      # input box ----
                                                      box(
                                                          width = 6,
                                                  ...
                                                  ) # END 2nd fluid row) # End Fossil Fuel Phaseout tabItem
                                          )   
                                          )  # End Dashboard Body
)
